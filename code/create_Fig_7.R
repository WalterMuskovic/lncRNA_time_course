...
vioplot_corr_dist <- function(bounds = c(0, 1E3, 1E4, 2.5E4, 5E4, 1E5, 2.5E5, 5E5, 1E6, 5E6, 1E7, 2.5E7),
                              bin_labels = c("<1Kb", "2-8Kb", "10-25Kb", "25-50Kb", "50-100Kb", "100-250Kb", "250-500Kb", "500Kb-1Mb", "1-5Mb", "5-10Mb", "10-25Mb", ">25Mb"),
                              input_df,
                              plot_title,
...
confInt_lines <- function(bounds=c(0, 1E3, 1E4, 2.5E4, 5E4, 1E5, 2.5E5, 5E5, 1E6, 5E6, 1E7, 2.5E7), quantiles_vectors = readRDS("data/block_bootstrap_quantiles_mouse.rds"), distance_vector){
